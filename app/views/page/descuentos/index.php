                ...
                <div class="form-group">
                    <div class="row gutter">
                        <div class="col-md-3">
                            ...
                            <select class="form-control" id="codsuc" name="codsuc" onchange="periodo()" disabled="disabled">
                                <?=$date['sucursales']?>
                            </select>
                            <input type="checkbox" id="todos" name="todos" checked disabled="disabled"> Todas las sucursales
                        </div>
                        <div class="col-md-2">
                            <label for="creditCard">Tipo</label>
